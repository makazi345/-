--==========================================================
--   MAKAZI MOD  •  v9.0  •  MOBILE EDITION
--==========================================================
print("=== MAKAZI MOD v9 START ===")
...
local function unloadFlyGUI_V3()
    ...
    notify("Fly GUI V3 выключен", false)
end
...
makeToggle(tabMain, "🦘  Бесконечный прыжок", false, function(s) infJumpEnabled = s end)
makeToggle(tabMain, "🦘  Двойной прыжок", false, function(s)
    doubleJumpOn = s
    doubleJumpUsed = false
end)
makeToggle(tabMain, "🏃  Авто-бег", false, function(s) autoSprintEnabled = s end)
...
-- УНИВЕРСАЛЬНЫЙ DRAG (для кружка-тигра и меню)
...
task.delay(1, function()
    notify("Makazi Mod v9 загружен ✅", true)
